...
import { Edit, Trash2, Building, Calendar, MapPin, Copy, MoreHorizontal } from "lucide-react"
...
export function ExperienceSection({ experiences, onDelete, onDuplicate, isLoading = false }: ExperienceSectionProps) {
      ...
      {experiences.length === 0 && (
        <Card className="border-dashed">
          <CardHeader className="text-center">
            ...
            <CardDescription>Click "Add Experience" to get started with your work history</CardDescription>
          </CardHeader>
        </Card>
      )}
    </div>
