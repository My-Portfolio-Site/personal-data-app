...
import { EditUserForm } from '@/app/(admin)/admin/users/_components/edit-user-form'
...
import { DeleteUserButton } from '@/app/(admin)/admin/users/_components/delete-user-button'
